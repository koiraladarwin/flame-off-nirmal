...
const IntroSection = () => {
  return (
    <>
    <div className="relative h-screen w-full flex flex-col md:flex-row items-center justify-between bg-white overflow-hidden">
      <div className="w-full md:w-1/2 h-1/2 md:h-full flex items-center justify-center p-4 md:p-0">
        <img
          src='/img/cctv camera.avif'
          alt="CCTV Camera"
      ...
      <div className="w-full md:w-1/2 px-4 md:px-8 flex flex-col gap-4 md:gap-6 justify-center py-8 md:py-0">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold max-w-md">
          WE OFFER<span className="text-lime-600">S</span> MORE THAN A SIMPLE SECURITY SYSTEM
        </h1>
