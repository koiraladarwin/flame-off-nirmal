...
const Process = () => {
  return (
    <>
    <div className="bg-yellow-200 text-white py-20 px-4 relative">
  
      <h2 className="text-6xl text-black font-bold text-center mb-4">Our Process</h2>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        {steps.map((step, idx) => (
          ...
          >
            {step.icon}
            <h3 className="text-xl font-semibold mt-3 mb-2 hover:text-green-600">{step.title}</h3>
